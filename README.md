...
## My
https://github.com/HumanSignal/label-studio/tree/ls-release/1.16.0?tab=readme-ov-file

```sh
# 浅克隆最近10次提交, 指定分支稳定版本
git clone https://github.com/HumanSignal/label-studio.git --depth 10 -b ls-release/1.16.0
# 创建并激活虚拟环境
uv venv
...
资源文件路径: D:\MuChenAI\Projects\label-studio\label_studio\core\static_buildv
